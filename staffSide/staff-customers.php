...
<link rel="stylesheet" href="staff-customers.css?v=<?= time() ?>">
</head>
<body>
...
<?php $staffNavActive = 'customers'; require __DIR__ . '/staff-sidebar-nav.php'; ?>
  </aside>
...
<script src="staff-customers.js?v=<?= time() ?>"></script>
</body>
</html>
