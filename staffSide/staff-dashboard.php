  ...
  <div class="main-content">
    ...
    <div class="page-content">
      ...
      <div class="access-banner">
        ...
        <span>You're logged in as <strong>Staff</strong>. You can manage bookings and orders, and view customer info. Audit logs and user management are <strong>admin-only</strong>.</span>
      </div>
