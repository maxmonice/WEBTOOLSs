...
<title>Staff Login — Luke's Seafood</title>
    ...
    <div class="auth-wrapper">
        <div class="auth-container" id="loginModal">
            <div class="modal-header">
                <div class="modal-fish-icon"><i class="fas fa-users-gear"></i></div>
                <h2 style="font-family: 'Aclonica', sans-serif;">STAFF PORTAL</h2>
                <p class="modal-sub">Authorized Personnel Access Only</p>
            </div>
            ...
            <form class="modal-form" id="loginForm" onsubmit="return false;">
                ...
                <div class="form-group">
                    <label for="emailInput">Staff Email</label>
                ...
                <div class="security-strip" style="margin-top: 30px; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.08); border-radius: 30px; padding: 8px 16px; display: flex; align-items: center; justify-content: center; gap: 8px;">
                    <i class="fas fa-check-shield" style="font-size: 0.7rem; color: #22c55e;"></i>
                    <div class="rider-strip-text" style="font-size: 0.72rem; color: rgba(255,255,255,0.5);">Verified Connection</div>
                </div>
            </form>
        </div>
    </div>
