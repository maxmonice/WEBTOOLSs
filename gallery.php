...
<head>
    ...
    <title>Gallery - Luke's Seafood Trading</title>
...
<body>
    ...
    <header>
        <div class="container header-container">
            ...
            <nav class="nav-menu" id="navMenu">
                ...
                <a href="account-dashboard.php" class="nav-account-icon">
                    <i class="fas fa-user-circle"></i>
                </a>
                <?php else: ?>
                <a href="account.php" class="nav-account-icon">
                    <i class="fas fa-user-circle"></i>
                </a>
                <?php endif; ?>
            </nav>
    ...
    <section class="hero">
        ...
        <div class="hero-content">
            ...
            <p class="hero-desc">A collection of our finest moments — from elegant sushi spreads<br>and live catering events to the freshest catches we proudly serve.</p>
        </div>
    </section>
