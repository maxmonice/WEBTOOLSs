...
$pdo = getDBConnection();
$isLoggedIn = isset($_SESSION['user_id']) && ($_SESSION['session_side'] ?? '') === 'customer';
?>
    ...
    <header>
        <div class="container header-container">
            ...
            <nav class="nav-menu" id="navMenu">
                ...
                <a href="account.php" class="nav-account-icon" id="navAccountIcon" onclick="const b=document.getElementById('orderSpeechBubble'); if(b) b.classList.remove('show');">
