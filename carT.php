...
<head>  
    ...
    <title>Luke's Seafood - Cart</title>
...
<body>
    ...
    <!-- Header (simplified, back to menu) -->
    <header>
    ...
    <!-- Cart Overlay (now main content) -->
    <div class="cart-overlay active" id="cartOverlay">
    ...
    <div class="qr-overlay" id="qrOverlay">
        <div class="qr-modal">
            ...
            <img src="https://github.com/maxmonice/WEBTOOLSs/raw/main/Screenshot%202026-04-12%20164726.png" alt="GCash QR Code" class="qr-image">
        </div>
    </div>
