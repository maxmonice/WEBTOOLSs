...
function requireAdmin(): void {
    if (empty($_SESSION['user_id']) || ($_SESSION['session_side'] ?? '') !== 'staff' || empty($_SESSION['is_admin'])) {
...
function requireAdminOrStaff(): void {
    if (empty($_SESSION['user_id']) || ($_SESSION['session_side'] ?? '') !== 'staff' || (empty($_SESSION['is_admin']) && empty($_SESSION['is_staff']))) {
        header('Location: ../account.php');
        exit;
    }
}
